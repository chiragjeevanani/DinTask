...
import { ArrowLeft, CheckCircle2, Calendar, Flag, AlignLeft, Tag, Plus, X } from 'lucide-react';
...
const AddTask = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        addTask({
            ...
            status: 'pending',
            progress: 0,
            assignedTo: ['1'], // Assigning to self
            activity: [
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className="w-full h-12 pl-10 pr-4 bg-white dark:bg-slate-900 border-none shadow-sm rounded-xl text-xs font-bold outline-none focus:ring-2 focus:ring-primary/20"
                                />
                            </div>
                        </div>
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <select
                                    ...
                                    className="w-full h-12 pl-10 pr-4 bg-white dark:bg-slate-900 border-none shadow-sm rounded-xl text-xs font-bold outline-none appearance-none focus:ring-2 focus:ring-primary/20"
                                >
