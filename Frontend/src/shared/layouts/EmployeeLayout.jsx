            ...
            <AnimatePresence>
                {showFooter && (
                    <motion.nav
                        ...
                        className="fixed bottom-6 left-1/2 w-[90%] max-w-[400px] h-16 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl rounded-2xl border border-white/20 dark:border-slate-700/50 shadow-2xl z-50 px-6 flex items-center justify-between"
                    >
                        {navItems.map((item) => (
                            <NavLink
                                key={item.path}
